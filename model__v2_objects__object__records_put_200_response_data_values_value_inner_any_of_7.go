...
// checks if the V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7{}

// V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7 struct for V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7
type V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7 struct {
...
type _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7 V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7
...
func NewV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7(activeFrom time.Time, activeUntil NullableTime, createdByActor V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOfCreatedByActor, line1 NullableString, line2 NullableString, line3 NullableString, line4 NullableString, locality NullableString, region NullableString, postcode NullableString, countryCode NullableString, latitude NullableString, longitude NullableString, attributeType string) *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7 {
	this := V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7{}
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) MarshalJSON() ([]byte, error) {
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) ToMap() (map[string]interface{}, error) {
...
func (o *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7 := _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7)

	if err != nil {
		return err
	}

	*o = V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7(varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7)

	return err
}

type NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7 struct {
	value *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7
	isSet bool
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) Get() *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7 {
	return v.value
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) Set(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7 {
	return &NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7{value: val, isSet: true}
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf7) UnmarshalJSON(src []byte) error {
	v.isSet = true
