...
// checks if the V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2{}

// V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2 struct for V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2
type V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2 struct {
...
type _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2 V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2
...
func NewV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2(activeFrom time.Time, activeUntil NullableTime, createdByActor V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOfCreatedByActor, currencyValue float32, attributeType string) *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2 {
	this := V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2{}
...
func (o *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) SetCurrencyCodeNil() {
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) MarshalJSON() ([]byte, error) {
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) ToMap() (map[string]interface{}, error) {
...
func (o *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2 := _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2)

	if err != nil {
		return err
	}

	*o = V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2(varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2)

	return err
}

type NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2 struct {
	value *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2
	isSet bool
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) Get() *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2 {
	return v.value
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) Set(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2 {
	return &NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2{value: val, isSet: true}
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
