...
// checks if the V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7{}

// V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7 struct for V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7
type V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7 struct {
...
type _V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7 V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7
...
func NewV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7(activeFrom time.Time, activeUntil NullableTime, createdByActor V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOfCreatedByActor, interactionType string, interactedAt time.Time, ownerActor V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOfCreatedByActor, attributeType string) *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7 {
	this := V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7{}
...
func (o V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) MarshalJSON() ([]byte, error) {
...
func (o V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) ToMap() (map[string]interface{}, error) {
...
func (o *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7 := _V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7{}

	err = json.Unmarshal(data, &varV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7)

	if err != nil {
		return err
	}

	*o = V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7(varV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7)
...
type NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7 struct {
	value *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7
	isSet bool
}

func (v NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) Get() *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7 {
	return v.value
}

func (v *NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) Set(val *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7(val *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) *NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7 {
	return &NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7{value: val, isSet: true}
}

func (v NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf7) UnmarshalJSON(src []byte) error {
	v.isSet = true
