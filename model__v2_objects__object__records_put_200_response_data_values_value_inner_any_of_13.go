...
// checks if the V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13{}

// V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13 struct for V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13
type V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13 struct {
...
type _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13 V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13
...
func NewV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13(activeFrom time.Time, activeUntil NullableTime, createdByActor V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOfCreatedByActor, attributeType string, value string) *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13 {
	this := V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13{}
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) MarshalJSON() ([]byte, error) {
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) ToMap() (map[string]interface{}, error) {
...
func (o *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13 := _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13)

	if err != nil {
		return err
	}

	*o = V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13(varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13)

	return err
}

type NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13 struct {
	value *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13
	isSet bool
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) Get() *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13 {
	return v.value
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) Set(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13 {
	return &NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13{value: val, isSet: true}
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf13) UnmarshalJSON(src []byte) error {
	v.isSet = true
