...
// checks if the V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3{}

// V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3 struct for V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3
type V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3 struct {
...
type _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3 V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3
...
func NewV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3(activeFrom time.Time, activeUntil NullableTime, createdByActor V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOfCreatedByActor, attributeType string, value string) *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3 {
	this := V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3{}
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) MarshalJSON() ([]byte, error) {
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) ToMap() (map[string]interface{}, error) {
...
func (o *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3 := _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3)

	if err != nil {
		return err
	}

	*o = V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3(varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3)

	return err
}

type NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3 struct {
	value *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3
	isSet bool
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) Get() *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3 {
	return v.value
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) Set(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3 {
	return &NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3{value: val, isSet: true}
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
