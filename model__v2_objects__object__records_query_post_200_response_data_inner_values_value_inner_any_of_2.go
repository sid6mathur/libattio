...
// checks if the V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2{}

// V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2 struct for V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2
type V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2 struct {
...
type _V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2 V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2
...
func NewV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2(activeFrom time.Time, activeUntil NullableTime, createdByActor V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOfCreatedByActor, currencyValue float32, attributeType string) *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2 {
	this := V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2{}
...
func (o *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) SetCurrencyCodeNil() {
...
func (o V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) MarshalJSON() ([]byte, error) {
...
func (o V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) ToMap() (map[string]interface{}, error) {
...
func (o *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2 := _V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2{}

	err = json.Unmarshal(data, &varV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2)

	if err != nil {
		return err
	}

	*o = V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2(varV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2)
...
type NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2 struct {
	value *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2
	isSet bool
}

func (v NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) Get() *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2 {
	return v.value
}

func (v *NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) Set(val *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2(val *V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) *NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2 {
	return &NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2{value: val, isSet: true}
}

func (v NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
