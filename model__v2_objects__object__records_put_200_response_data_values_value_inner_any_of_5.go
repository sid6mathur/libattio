...
// checks if the V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5{}

// V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5 struct for V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5
type V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5 struct {
...
type _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5 V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5
...
func NewV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5(activeFrom time.Time, activeUntil NullableTime, createdByActor V2ObjectsObjectRecordsQueryPost200ResponseDataInnerValuesValueInnerAnyOfCreatedByActor, targetObject string, targetRecordId string, attributeType string) *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5 {
	this := V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5{}
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) MarshalJSON() ([]byte, error) {
...
func (o V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) ToMap() (map[string]interface{}, error) {
...
func (o *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5 := _V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5)

	if err != nil {
		return err
	}

	*o = V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5(varV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5)

	return err
}

type NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5 struct {
	value *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5
	isSet bool
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) Get() *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5 {
	return v.value
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) Set(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5(val *V2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5 {
	return &NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5{value: val, isSet: true}
}

func (v NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ObjectsObjectRecordsPut200ResponseDataValuesValueInnerAnyOf5) UnmarshalJSON(src []byte) error {
	v.isSet = true
